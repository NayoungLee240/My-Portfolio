...
const fallbackSkills: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "RDS Proxy", type: "primary" },
      { name: "Docker", type: "primary" },
      { name: "Linux", type: "primary" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "EroLabs", type: "primary" },
      { name: "Session Mgmt", type: "gray" },
      { name: "차단·UID 화이트리스트", type: "gray" },
    ],
  },
  {
    category: "TOOLS & ETC",
